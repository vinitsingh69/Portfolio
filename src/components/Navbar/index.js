  ...
  return (
    <Nav>
      <NavbarContainer> 
        ...
        <MobileNavLogo to='/'> </MobileNavLogo>
...

        {
          ...
          <MobileMenu isOpen={isOpen}>
            ...
            <GitHubButton style={{ padding: '10px 16px', background: `${theme.primary}`, color: 'white', width: 'max-content' }} href={Bio.github} target="_blank">Check Github</GitHubButton>
          </MobileMenu>
        }
